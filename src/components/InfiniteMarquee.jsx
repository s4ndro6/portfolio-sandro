...
/*
  FIX: OFFICIAL BRAND LOGOS & SIZE
  - CDN: simpleicons.org/white
  - Size: 45px height
  - Spacing: 50px gap
  - No Filters
*/
            ...
            >
                <motion.div
                    ...
                    style={{
                        ...
                        display: 'flex',
                        alignItems: 'center',
                        gap: '50px' // Enforcing 50px gap as requested
                    }}
                >
                    {[...tools, ...tools, ...tools, ...tools].map((tool, idx) => (
                        ...
                        >
                            {/* IMG TAG RESTORED with height 45px and NO FILTERS */}
                            <img
                                src={tool.icon}
                                alt={tool.name}
                                ...
                                style={{
                                    ...
                                    width: 'auto',
                                    objectFit: 'contain',
                                    filter: 'none' // Explicitly no filters
                                }}
                            />
