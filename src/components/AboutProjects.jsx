      ...
      <AnimatePresence>
        {selectedProject && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            <motion.div layoutId={`p-${selectedProject.id}`} className="bg-[#0F0F0F] border border-white/10 w-full max-w-5xl max-h-[90vh] overflow-y-auto rounded-3xl relative z-10 flex flex-col md:flex-row shadow-2xl">
